...
export const SIMS: Sim[] = [
  ...
  },
  {
    ...
    title: "Threshold Policy Studio",
    short: "โมเดลเสร็จแล้ว แต่ต้องขีดเส้นที่เท่าไร — accuracy สูงสุดแพงกว่าจุดที่ถูกต้องหลายแสนบาท",
    icon: "🎯",
    weeks: "W5–W6, W9",
    concept: "Confusion Matrix · Precision/Recall · ต้นทุนที่ไม่สมมาตรของ FP กับ FN",
    misconception: "เลือกโมเดลและ threshold จากค่า accuracy สูงสุดเสมอ",
    ready: true,
  },
  {
    slug: "leakage-hunter",
    title: "Leakage Hunter",
    short: "AUC 1.0000 ไม่ใช่ความสำเร็จ แต่คือรายงานบั๊ก — ล่าตัวแปรที่รั่วมาจากอนาคต",
    icon: "🕵️",
    weeks: "W5",
    concept: "Data leakage · temporal validation · population drift · calibration",
    misconception: "คิดว่าโมเดลที่แม่นบนชุดทดสอบคือโมเดลที่ใช้งานได้จริง",
    ready: true,
  },
  {
    slug: "tree-grower",
    title: "Decision Tree Grower",
    short: "ปลูกต้นไม้ตัดสินใจด้วยมือทีละคำถาม แล้วเทียบกับสิ่งที่ Information Gain บอก",
    icon: "🌳",
    weeks: "W5",
    concept: "Entropy · Information Gain · ต้นไม้ที่อธิบายได้ · ตัวแปรที่ไร้ประโยชน์",
    misconception: "เลือกตัวแปรจากความรู้สึกว่าน่าจะสำคัญ แทนที่จะวัดด้วยหลักฐาน",
    ready: true,
  },
  {
    slug: "segment-studio",
    title: "Segment Studio",
    short: "แบ่งกลุ่มลูกค้าด้วย RFM — ลืม normalize แล้วได้แค่การแบ่งช่วงยอดเงิน ไม่ใช่กลุ่มพฤติกรรม",
    icon: "👥",
    weeks: "W6",
    concept: "K-Means · RFM · การปรับสเกล · Elbow และ Silhouette",
    misconception: "คิดว่าปรับสเกลเป็นขั้นตอนเสริม และเลือกโมเดลจากคะแนน silhouette เพียงอย่างเดียว",
    ready: true,
  },
  {
    slug: "lift-detective",
    title: "Lift Detective",
    short: "เรียงกฎตาม confidence แล้วได้แต่กฎไร้ค่า เพราะปลายทางเป็นของที่อยู่ใน 81% ของทุกตะกร้า",
    icon: "🧺",
    weeks: "W6",
    concept: "Market Basket · Support/Confidence/Lift · ความสัมพันธ์ไม่ใช่เหตุและผล",
    misconception: "เชื่อว่า confidence สูงแปลว่ากฎมีค่า และคิดว่ากฎที่พบคือข้อสรุปที่นำไปทำได้เลย",
    ready: true,
  },
  {
    slug: "cluster-reality-check",
    title: "Cluster Reality Check",
    short: "K-Means คืนกลุ่มมาให้เสมอ แม้ป้อนจุดสุ่มล้วนเข้าไป — แล้วจะรู้ได้อย่างไรว่าผลใช้ได้",
    icon: "🔬",
    weeks: "W6",
    concept: "การตรวจสอบ unsupervised learning · ข้อมูลอ้างอิงแบบสุ่ม · ความเสถียรของกลุ่ม",
    misconception: "คิดว่าถ้าอัลกอริทึมรันผ่านและได้คะแนนพอใช้ แปลว่าผลลัพธ์มีความหมาย",
    ready: true,
  },
  {
